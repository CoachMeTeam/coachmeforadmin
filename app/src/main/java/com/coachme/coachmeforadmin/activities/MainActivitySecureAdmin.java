...
public class MainActivitySecureAdmin extends AppCompatActivity {
    //variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_secure_admin);
    }
            ...
            public void onClick(View view) {
                    //test du code admin
                        ...
                        if (testCodeAdmin(Code)) {
                            ...
                            Intent i = new Intent(getApplicationContext(), ActivityFormulaireAjout.class);
                            startActivity(i);
                        } else {
